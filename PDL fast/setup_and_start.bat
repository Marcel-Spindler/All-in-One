@echo off
REM ============================================================
REM  PDL Fast - Self-Bootstrapping Launcher
REM  Voraussetzung: Python 3.10+ ist auf dem Rechner installiert
REM  (https://www.python.org/downloads/windows/  - Haken
REM   "Add Python to PATH" beim Setup aktivieren).
REM ============================================================
...
if not exist "%PYEXE%" (
    ...
    echo [Setup] Installiere Pakete ^(einmalig, 2-3 Minuten^) ...
...
if errorlevel 1 (
    echo [Start] Starte PDL Fast ...
    start "PDL Fast" "%PYEXE%" -m streamlit run "%ROOT%\app.py" --server.port 8502 --server.headless true --browser.gatherUsageStats false
